...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textInfoMe;

  @NonNull
  public final TextView textTitle;

  private FragmentAboutBinding(@NonNull FrameLayout rootView, @NonNull TextView textInfo,
      @NonNull TextView textInfoMe, @NonNull TextView textTitle) {
    this.rootView = rootView;
    this.textInfo = textInfo;
    this.textInfoMe = textInfoMe;
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textInfoMe;
      TextView textInfoMe = ViewBindings.findChildViewById(rootView, id);
      if (textInfoMe == null) {
        break missingId;
      }
      ...
      return new FragmentAboutBinding((FrameLayout) rootView, textInfo, textInfoMe, textTitle);
    }
